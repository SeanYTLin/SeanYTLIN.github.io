...
function setBackgroundColor(color) {
    ...
    let bgcolor = document.getElementById("q1-container")
...
function greenButtionClicked() {
    setBackgroundColor("#06D6A0")
}

document.getElementById("q1-btn-green").onclick = greenButtionClicked;
...
function LBButtionClicked() {
    setBackgroundColor("#118AB2")
}

document.getElementById("q1-btn-lightblue").onclick = LBButtionClicked;
...
function blueButtionClicked() {
    setBackgroundColor("#073B4C")
}

document.getElementById("q1-btn-blue").onclick = blueButtionClicked;
